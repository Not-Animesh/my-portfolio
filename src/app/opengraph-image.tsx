...
export default async function Image() {
    try {
        ...
        // Safely extract avatarUrl and description from DATA
        const dataObj = DATA as Record<string, any>;
        const avatarUrl = dataObj.avatarUrl
            ? new URL(dataObj.avatarUrl, DATA.url).toString()
            : undefined;
                        ...
                        <div style={styles.wrapper}>
                            {avatarUrl && (
                                <div style={styles.imageSection}>
                                    <img src={avatarUrl} alt={DATA.name} style={styles.image} />
                                </div>
                            )}
